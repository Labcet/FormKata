                ...
                <table class="table table-striped table-bordered">
                    ...
                    @foreach($cps as $key => $value)
                        <tr>
                            ...
                            <td style="background: #13c3f3; color:#fff;">
                                ...
                                <div class="input-group">
                                    <button type="button" style="background: #fdce04; border: none; margin-right: 10px;" class="modalCP btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg" data-comp="{{ $value }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                                            <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z"/>
                                            <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z"/>
                                        </svg>
                                    </button>
                                    <a type="button" id="observar" class="btn btn-primary" style="background: #ff287b; border: none; margin-right: 10px;" href="{{ route('observaCP', $value->id) }}" onclick="alert">
                                    ...
                                    <a type="button" id="aprobar" class="btn btn-primary" style="background: #019500; border: none; margin-right: 10px;" href="{{ route('apruebaCP', $value->id) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-circle" viewBox="0 0 16 16">
                                            <path d="M2.5 8a5.5 5.5 0 0 1 8.25-4.764.5.5 0 0 0 .5-.866A6.5 6.5 0 1 0 14.5 8a.5.5 0 0 0-1 0 5.5 5.5 0 1 1-11 0z"/>
                                            <path d="M15.354 3.354a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l7-7z"/>
                                        </svg>                                    
                                    </a>
                                    <a type="button" id="aprobar" class="btn btn-primary" style="background: #fdce04; border: none; margin-right: 10px;" href="{{ route('pdf', $value->id) }}">
                        ...
                        <tr>
                            <td colspan="3">
                                <div class="container">
                                    <evidencias-component :id-cp="{{ $value->id }}"></evidencias-component>
                                </div>
                            </td>
                        </tr>
                    @endforeach
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        //const store = Vue.observable({testCaseIdProp: 1});
        var testCaseIdProp = 1;
        //alert(testCaseIdProp);
